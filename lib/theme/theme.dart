  ...
  static ThemeData _buildTheme(Brightness brightness) {
    ...
    final formDesignThemeColors = isDark
        ? const FormDesignThemeColors(
            ...
            signOffFlowApprove: AppColors.signOffFlowApprove,
            signOffFlowCountersign: AppColors.signOffFlowCountersign,
            signOffFlowNotify: AppColors.signOffFlowNotify,
          )
        : const FormDesignThemeColors(
            pageGradient: [
    ...
    final formApplicationThemeColors = isDark
        ? const FormApplicationThemeColors(
            pageBackground: AppColors.appFormApplicationPageBackgroundDark,
            errorColor: AppColors.appFormApplicationErrorDark,
            subtitleText: AppColors.appFormApplicationSubtitleTextDark,
            searchFill: AppColors.appFormApplicationSearchFillDark,
            emptyText: AppColors.appFormApplicationEmptyTextDark,
            formIcon: AppColors.appFormApplicationFormIconDark,
            hintText: AppColors.appFormApplicationHintTextDark,
            submittedIcon: AppColors.appFormApplicationSubmittedIconDark,
            pendingIcon: AppColors.appFormApplicationPendingIconDark,
            inReviewIcon: AppColors.appFormApplicationInReviewIconDark,
            withdrawnIcon: AppColors.appFormApplicationWithdrawnIconDark,
            cardBackground: AppColors.appFormApplicationCardBackgroundDark,
            cardBorder: AppColors.appFormApplicationCardBorderDark,
            listTitleText: AppColors.appFormApplicationListTitleTextDark,
            listSubtitleText: AppColors.appFormApplicationListSubtitleTextDark,
            chipBackground: AppColors.appFormApplicationChipBackgroundDark,
          )
        : const FormApplicationThemeColors(
            pageBackground: AppColors.appFormApplicationPageBackgroundLight,
            errorColor: AppColors.appFormApplicationErrorLight,
            subtitleText: AppColors.appFormApplicationSubtitleTextLight,
            searchFill: AppColors.appFormApplicationSearchFillLight,
            emptyText: AppColors.appFormApplicationEmptyTextLight,
            formIcon: AppColors.appFormApplicationFormIconLight,
            hintText: AppColors.appFormApplicationHintTextLight,
            submittedIcon: AppColors.appFormApplicationSubmittedIconLight,
            pendingIcon: AppColors.appFormApplicationPendingIconLight,
            inReviewIcon: AppColors.appFormApplicationInReviewIconLight,
            withdrawnIcon: AppColors.appFormApplicationWithdrawnIconLight,
            cardBackground: AppColors.appFormApplicationCardBackgroundLight,
            cardBorder: AppColors.appFormApplicationCardBorderLight,
            listTitleText: AppColors.appFormApplicationListTitleTextLight,
            listSubtitleText: AppColors.appFormApplicationListSubtitleTextLight,
            chipBackground: AppColors.appFormApplicationChipBackgroundLight,
          );
